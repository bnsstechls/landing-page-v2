...
export function MagicCard({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex flex-col items-center justify-center p-6 bg-[#111111] border border-white/20 rounded-lg shadow-lg cursor-pointer",
        className,
      )}
    >
      <div className="flex flex-col items-center mb-4">{children}</div>
      {/* Add the hover effect here if needed */}
      <motion.div
